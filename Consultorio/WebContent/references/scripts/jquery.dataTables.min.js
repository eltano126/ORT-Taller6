...
this._iDisplayStart + this.aiDisplay.length : Math.min(this._iDisplayStart + this._iDisplayLength, this._iRecordsDisplay) : this._iDisplayEnd
                ...
                sLengthMenu: "Mostrar _MENU_ registros", sZeroRecords: "No se encontraron registros", sEmptyTable: "No hay datos disponibles en la tabla", sInfo: "Mostrando _START_ hasta _END_ de _TOTAL_ registros", sInfoEmpty: "Mostrando 0 hasta 0 de 0 registros", sInfoFiltered: "(filtrado de _MAX_ entradas totales)", sInfoPostFix: "", sSearch: "Buscar:", sUrl: "", oPaginate: { sFirst: "Primera", sPrevious: "Anterior", sNext: "Siguiente", sLast: "Ultimo" }, fnInfoCallback: null
